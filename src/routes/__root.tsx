  ...
  head: () => ({
    meta: [
      ...
      { title: "Sadguru Enterprise | RO Sales & Service Manager" },
      {
        name: "description",
        content:
          "Desktop manager for RO purifier sales, 4/8/12-month service reminders and automated WhatsApp customer messaging.",
      },
      { name: "author", content: "Sadguru Enterprise" },
      { property: "og:title", content: "Sadguru Enterprise RO Manager" },
      {
        property: "og:description",
        content: "RO customer records, service reminders and WhatsApp automation.",
      },
